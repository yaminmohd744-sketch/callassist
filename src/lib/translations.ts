...
export interface T {
  ...
  precall: {
    ...
    callTypeQuestion: string;
    inCrmQuestion: string;
    callGoal: string;
    callGoalPlaceholder: string;
    yourPitch: string;
    yourPitchPlaceholder: string;
    yourPerksLabel: string;
    yourPerksDesc: string;
    crmRequired: string;
    crmSignInRequired: string;
    language: string;
    startCall: string;
  };
  // Live call
  liveCall: {
    ...
    stageClose: string;
    profile: string;
    listeningBubble: string;
    generatingReport: string;
    noTranscript: string;
    summaryFailed: string;
    micUnavailable: string;
    bodyUnavailable: (error: string) => string;
...
const en: T = {
  ...
  analytics: {
    ...
    showLess: 'Show less',
    showAllCalls: n => `Show all ${n} calls`,
    teamComingSoon: 'Coming soon — connect your team',
  },
  trainingExtra: {
  ...
  precall: {
    ...
    desc: 'Give the AI context before your call. The more specific you are, the sharper the coaching.',
    prospectName: 'Prospect Name',
    prospectNamePlaceholder: 'e.g. John Smith',
    company: 'Company',
    companyPlaceholder: 'e.g. Acme Corp',
    callTypeQuestion: 'What type of call is this?',
    inCrmQuestion: 'Is this lead in your CRM?',
    callGoal: 'Call Goal',
    callGoalPlaceholder: 'e.g. Book a demo, close the deal...',
    yourPitch: 'Your Pitch / Product',
    yourPitchPlaceholder: 'What are you selling?',
    yourPerksLabel: 'Your Perks',
    yourPerksDesc: 'List everything great about your service — features, guarantees, pricing, differentiators. The AI will use this during the call.',
    crmRequired: 'Please select a lead from your CRM',
    crmSignInRequired: 'Sign in to load your CRM leads',
    language: 'Language',
    startCall: 'Start Call',
  },
  liveCall: {
    endCall: 'End Call', mute: 'Mute', unmute: 'Unmute', aiSuggestions: 'AI Suggestions', transcript: 'Transcript', closeProbability: 'Close Probability', stage: 'Stage', note: 'Note', addNote: 'Add note...', listening: 'Listening...', liveMode: 'LIVE MODE', noProspect: 'No prospect', active: 'ACTIVE', standby: 'STANDBY', objections: 'OBJECTIONS', closeProb: 'CLOSE PROB', aiFeed: 'AI INTELLIGENCE FEED', coaching: 'COACHING', readyToAssist: 'Ready to Assist', readyDesc: 'Click Listen in the transcript panel to start your mic. I\'ll detect objections, buying signals, and coach you in real-time.', transcriptFeed: 'TRANSCRIPT FEED', live: 'LIVE', you: 'YOU', prospect: 'PROSPECT', system: 'SYSTEM', listeningStatus: 'Listening — speakers are detected automatically.', micStarting: 'Mic starting... or type prospect dialogue below.', typeProspect: 'Type what the prospect said...', typeRep: 'Type your response...', leadProfile: 'LEAD PROFILE', name: 'Name', company: 'Company', goal: 'Goal', pitch: 'Pitch', callStats: 'CALL STATS', quickActions: 'QUICK ACTIONS', callNotes: 'CALL NOTES', noLeadData: 'No lead data extracted yet. Start a conversation to build the profile.', summarizeCall: 'Summarize call', generateEmail: 'Generate follow-up email', exportLead: 'Export lead data', scoreLead: 'Score this lead', stageOpener: 'OPENER', stageDiscovery: 'DISCOVERY', stagePitch: 'PITCH', stageClose: 'CLOSE', profile: 'PROFILE', listeningBubble: 'Listening to your call…', generatingReport: 'Generating your coaching report…', noTranscript: 'No transcript yet — start speaking before ending the call.', summaryFailed: 'Summary generation failed — call saved without AI coaching', micUnavailable: 'Microphone unavailable — transcription disabled', bodyUnavailable: error => `Body language coaching unavailable — ${error}`, draftFound: time => `Unsaved transcript found from ${time} — restore it?`, draftRestore: 'Restore', draftDismiss: 'Dismiss', shareScreen: 'Share Screen',
  },
  postcall: {
    title: 'Call Review',
    summary: 'Summary',
  ...
  errors: {
    ...
    transcriptRequired: 'Paste a transcript or upload a .txt file first.',
  },
  leads: {
    title: 'CRM',
...
const es: T = {
  ...
  common: { back: 'Volver', cancel: 'Cancelar', save: 'Guardar', send: 'Enviar', start: 'Iniciar', done: 'Hecho', close: 'Cerrar', loading: 'Cargando...', signOut: 'Cerrar sesión', next: 'Siguiente', skip: 'Omitir', edit: 'Editar', delete: 'Eliminar', confirm: 'Confirmar', tryAgain: 'Intentar de nuevo', learnMore: 'Saber más', or: 'o', yes: 'Sí', no: 'No', change: 'Cambiar' },
  profile: { activity: 'ACTIVIDAD',calls: n => `${n} llamada${n !== 1 ? 's' : ''}`, trainingSessions: n => `${n} sesión${n !== 1 ? 'es' : ''} de entrenamiento`, totalOnPlatform: 'total en la plataforma', maxRank: '✦ Rango máximo alcanzado', appLanguage: 'Idioma de la app', langNote: 'Afecta el idioma del coaching y el entrenamiento. Se puede cambiar por llamada en la configuración previa.' },
  ...
  onboarding: { welcome: 'Bienvenido a Pitchr', yourName: 'Tu Nombre', yourNamePlaceholder: 'p.ej. Alex García', yourRole: 'Tu Rol', yourRolePlaceholder: 'p.ej. Ejecutivo de Cuentas', whatYouSell: '¿Qué vendes?', whatYouSellPlaceholder: 'p.ej. SaaS, consultoría, seguros...', language: 'Idioma Preferido', letsGo: 'Vamos →' },
  upload: { title: 'Subir Grabación', subtitle: 'Sube una grabación para obtener coaching de IA y un resumen completo.', dropzone: 'Suelta tu archivo de audio aquí', analyzing: 'Analizando tu llamada...', browseFiles: 'Buscar archivos', analyzeTranscript: 'Analizar Transcripción' },
...
const fr: T = {
  ...
  common: { back: 'Retour', cancel: 'Annuler', save: 'Enregistrer', send: 'Envoyer', start: 'Démarrer', done: 'Terminé', close: 'Fermer', loading: 'Chargement...', signOut: 'Se déconnecter', next: 'Suivant', skip: 'Passer', edit: 'Modifier', delete: 'Supprimer', confirm: 'Confirmer', tryAgain: 'Réessayer', learnMore: 'En savoir plus', or: 'ou', yes: 'Oui', no: 'Non', change: 'Modifier' },
  profile: { activity: 'ACTIVITÉ', calls: n => `${n} appel${n !== 1 ? 's' : ''}`, trainingSessions: n => `${n} session${n !== 1 ? 's' : ''} d'entraînement`, totalOnPlatform: 'total sur la plateforme', maxRank: '✦ Rang maximum atteint', appLanguage: 'Langue de l\'app', langNote: 'Affecte la langue du coaching et de l\'entraînement. Peut être changé par appel dans la configuration.' },
  ...
  onboarding: { welcome: 'Bienvenue sur Pitchr', yourName: 'Votre Nom', yourNamePlaceholder: 'ex. Alex Martin', yourRole: 'Votre Rôle', yourRolePlaceholder: 'ex. Responsable Commercial', whatYouSell: 'Que vendez-vous ?', whatYouSellPlaceholder: 'ex. SaaS, conseil, assurance...', language: 'Langue Préférée', letsGo: 'C\'est parti →' },
  upload: { title: 'Importer un Enregistrement', subtitle: 'Importez un enregistrement pour obtenir un coaching IA et un compte-rendu complet.', dropzone: 'Déposez votre fichier audio ici', analyzing: 'Analyse de votre appel...', browseFiles: 'Parcourir les fichiers', analyzeTranscript: 'Analyser la Transcription' },
...
const pt: T = {
  ...
  common: { back: 'Voltar', cancel: 'Cancelar', save: 'Salvar', send: 'Enviar', start: 'Iniciar', done: 'Concluído', close: 'Fechar', loading: 'Carregando...', signOut: 'Sair', next: 'Próximo', skip: 'Pular', edit: 'Editar', delete: 'Excluir', confirm: 'Confirmar', tryAgain: 'Tentar novamente', learnMore: 'Saiba mais', or: 'ou', yes: 'Sim', no: 'Não', change: 'Alterar' },
  profile: { activity: 'ATIVIDADE', calls: n => `${n} chamada${n !== 1 ? 's' : ''}`, trainingSessions: n => `${n} sessão${n !== 1 ? 'ões' : ''} de treinamento`, totalOnPlatform: 'total na plataforma', maxRank: '✦ Rank máximo atingido', appLanguage: 'Idioma do app', langNote: 'Afeta o idioma do coaching e treinamento. Pode ser alterado por chamada nas configurações.' },
  ...
  onboarding: { welcome: 'Bem-vindo ao Pitchr', yourName: 'Seu Nome', yourNamePlaceholder: 'ex. Alex Santos', yourRole: 'Seu Cargo', yourRolePlaceholder: 'ex. Executivo de Contas', whatYouSell: 'O que você vende?', whatYouSellPlaceholder: 'ex. SaaS, consultoria, seguros...', language: 'Idioma Preferido', letsGo: 'Vamos →' },
  upload: { title: 'Enviar Gravação', subtitle: 'Envie uma gravação para obter coaching de IA e um resumo completo.', dropzone: 'Solte seu arquivo de áudio aqui', analyzing: 'Analisando sua chamada...', browseFiles: 'Procurar arquivos', analyzeTranscript: 'Analisar Transcrição' },
...
const de: T = {
  ...
  common: { back: 'Zurück', cancel: 'Abbrechen', save: 'Speichern', send: 'Senden', start: 'Starten', done: 'Fertig', close: 'Schließen', loading: 'Lädt...', signOut: 'Abmelden', next: 'Weiter', skip: 'Überspringen', edit: 'Bearbeiten', delete: 'Löschen', confirm: 'Bestätigen', tryAgain: 'Nochmal versuchen', learnMore: 'Mehr erfahren', or: 'oder', yes: 'Ja', no: 'Nein', change: 'Ändern' },
  profile: { activity: 'AKTIVITÄT', calls: n => `${n} Anruf${n !== 1 ? 'e' : ''}`, trainingSessions: n => `${n} Trainingseinheit${n !== 1 ? 'en' : ''}`, totalOnPlatform: 'gesamt auf der Plattform', maxRank: '✦ Maximaler Rang erreicht', appLanguage: 'App-Sprache', langNote: 'Beeinflusst die Coaching- und Trainingssprache. Im Vorab-Setup pro Anruf änderbar.' },
  ...
  onboarding: { welcome: 'Willkommen bei Pitchr', yourName: 'Ihr Name', yourNamePlaceholder: 'z.B. Alex Müller', yourRole: 'Ihre Position', yourRolePlaceholder: 'z.B. Account Executive', whatYouSell: 'Was verkaufen Sie?', whatYouSellPlaceholder: 'z.B. SaaS, Beratung, Versicherung...', language: 'Bevorzugte Sprache', letsGo: 'Los geht\'s →' },
  upload: { title: 'Aufnahme Hochladen', subtitle: 'Laden Sie eine Aufnahme hoch für KI-Coaching und ein vollständiges Debriefing.', dropzone: 'Audiodatei hier ablegen', analyzing: 'Anruf wird analysiert...', browseFiles: 'Dateien durchsuchen', analyzeTranscript: 'Transkript Analysieren' },
...
const it: T = {
  ...
  common: { back: 'Indietro', cancel: 'Annulla', save: 'Salva', send: 'Invia', start: 'Avvia', done: 'Fatto', close: 'Chiudi', loading: 'Caricamento...', signOut: 'Esci', next: 'Avanti', skip: 'Salta', edit: 'Modifica', delete: 'Elimina', confirm: 'Conferma', tryAgain: 'Riprova', learnMore: 'Scopri di più', or: 'o', yes: 'Sì', no: 'No', change: 'Modifica' },
  profile: { activity: 'ATTIVITÀ', calls: n => `${n} chiamata${n !== 1 ? 'e' : ''}`, trainingSessions: n => `${n} sessione${n !== 1 ? 'i' : ''} di formazione`, totalOnPlatform: 'totale sulla piattaforma', maxRank: '✦ Rango massimo raggiunto', appLanguage: 'Lingua dell\'app', langNote: 'Influisce sulla lingua del coaching e della formazione. Modificabile per chiamata nella configurazione.' },
  ...
  onboarding: { welcome: 'Benvenuto su Pitchr', yourName: 'Il Tuo Nome', yourNamePlaceholder: 'es. Alex Rossi', yourRole: 'Il Tuo Ruolo', yourRolePlaceholder: 'es. Account Executive', whatYouSell: 'Cosa vendi?', whatYouSellPlaceholder: 'es. SaaS, consulenza, assicurazione...', language: 'Lingua Preferita', letsGo: 'Andiamo →' },
  upload: { title: 'Carica Registrazione', subtitle: 'Carica una registrazione per ottenere coaching IA e un debriefing completo.', dropzone: 'Trascina il tuo file audio qui', analyzing: 'Analisi della chiamata in corso...', browseFiles: 'Sfoglia file', analyzeTranscript: 'Analizza Trascrizione' },
...
const nl: T = {
  ...
  common: { back: 'Terug', cancel: 'Annuleren', save: 'Opslaan', send: 'Versturen', start: 'Starten', done: 'Klaar', close: 'Sluiten', loading: 'Laden...', signOut: 'Uitloggen', next: 'Volgende', skip: 'Overslaan', edit: 'Bewerken', delete: 'Verwijderen', confirm: 'Bevestigen', tryAgain: 'Opnieuw proberen', learnMore: 'Meer weten', or: 'of', yes: 'Ja', no: 'Nee', change: 'Wijzigen' },
  profile: { activity: 'ACTIVITEIT', calls: n => `${n} gesprek${n !== 1 ? 'ken' : ''}`, trainingSessions: n => `${n} trainingssessie${n !== 1 ? 's' : ''}`, totalOnPlatform: 'totaal op het platform', maxRank: '✦ Maximale rang bereikt', appLanguage: 'App-taal', langNote: 'Beïnvloedt de taal van coaching en training. Per gesprek aanpasbaar in de voorbereiding.' },
  ...
  precall: { title: 'Gespreksvoorbereiding', desc: 'Give the AI context before your call. The more specific you are, the sharper the coaching.', prospectName: 'Naam Prospect', prospectNamePlaceholder: 'bijv. Jan de Vries', company: 'Bedrijf', companyPlaceholder: 'bijv. Acme BV', callTypeQuestion: 'Wat voor soort gesprek is dit?', inCrmQuestion: 'Staat deze lead in uw CRM?', callGoal: 'Gespreksdoel', callGoalPlaceholder: 'bijv. Demo boeken, deal sluiten...', yourPitch: 'Uw Aanbod / Product', yourPitchPlaceholder: 'Wat verkoopt u?', yourPerksLabel: 'Uw Voordelen', yourPerksDesc: 'List everything great about your service — features, guarantees, pricing, differentiators. The AI will use this during the call.', crmRequired: 'Please select a lead from your CRM', crmSignInRequired: 'Sign in to load your CRM leads', language: 'Taal', startCall: 'Gesprek Starten' },
  liveCall: { endCall: 'Gesprek Beëindigen', mute: 'Dempen', unmute: 'Dempen opheffen', aiSuggestions: 'AI-Suggesties', transcript: 'Transcript', closeProbability: 'Kans op Afsluiting', stage: 'Fase', note: 'Notitie', addNote: 'Notitie toevoegen...', listening: 'Luistert...', liveMode: 'LIVE MODUS', noProspect: 'Geen prospect', active: 'ACTIEF', standby: 'STAND-BY', objections: 'BEZWAREN', closeProb: 'AFSLUITKANS', aiFeed: 'AI INTELLIGENTIE FEED', coaching: 'COACHING', readyToAssist: 'Klaar om te Helpen', readyDesc: 'Klik op Luisteren in het transcriptpaneel om de microfoon te starten.', transcriptFeed: 'TRANSCRIPT FEED', live: 'LIVE', you: 'U', prospect: 'PROSPECT', system: 'SYSTEEM', listeningStatus: 'Luistert — sprekers worden automatisch gedetecteerd.', micStarting: 'Microfoon start... of typ het prospectdialoog hieronder.', typeProspect: 'Typ wat de prospect zei...', leadProfile: 'PROSPECT PROFIEL', name: 'Naam', company: 'Bedrijf', goal: 'Doel', pitch: 'Pitch', callStats: 'GESPREKSSTATISTIEKEN', quickActions: 'SNELLE ACTIES', callNotes: 'GESPREKSNOTITIES', noLeadData: 'Nog geen prospectgegevens. Start een gesprek om het profiel op te bouwen.', summarizeCall: 'Gesprek samenvatten', generateEmail: 'Opvolg-e-mail genereren', exportLead: 'Prospectgegevens exporteren', scoreLead: 'Dit prospect beoordelen', stageOpener: 'OPENER', stageDiscovery: 'VERKENNING', stagePitch: 'PITCH', stageClose: 'AFSLUITING', profile: 'PROFIEL', listeningBubble: 'Listening to your call…', generatingReport: 'Generating your coaching report…', noTranscript: 'No transcript yet — start speaking before ending the call.', summaryFailed: 'Summary generation failed — call saved without AI coaching', micUnavailable: 'Microphone unavailable — transcription disabled', bodyUnavailable: error => `Body language coaching unavailable — ${error}`, draftFound: time => `Unsaved transcript found from ${time} — restore it?`, draftRestore: 'Herstellen', draftDismiss: 'Negeren' },
  ...
  onboarding: { welcome: 'Welkom bij Pitchr', yourName: 'Uw Naam', yourNamePlaceholder: 'bijv. Alex de Vries', yourRole: 'Uw Functie', yourRolePlaceholder: 'bijv. Account Executive', whatYouSell: 'Wat verkoopt u?', whatYouSellPlaceholder: 'bijv. SaaS, advies, verzekering...', language: 'Voorkeurstaal', letsGo: 'Aan de slag →' },
  upload: { title: 'Opname Uploaden', subtitle: 'Upload een opname voor AI-coaching en een volledig debriefing.', dropzone: 'Sleep uw audiobestand hier', analyzing: 'Gesprek analyseren...', browseFiles: 'Bestanden zoeken', analyzeTranscript: 'Transcriptie Analyseren' },
...
const zh: T = {
  ...
  common: { back: '返回', cancel: '取消', save: '保存', send: '发送', start: '开始', done: '完成', close: '关闭', loading: '加载中...', signOut: '退出登录', next: '下一步', skip: '跳过', edit: '编辑', delete: '删除', confirm: '确认', tryAgain: '重试', learnMore: '了解更多', or: '或', yes: '是', no: '否', change: '更改' },
  profile: { activity: '活动', calls: n => `${n} 次通话`, trainingSessions: n => `${n} 次训练`, totalOnPlatform: '平台总时长', maxRank: '✦ 已达最高等级', appLanguage: '应用语言', langNote: '影响辅导和训练语言。可在通话前设置中逐次更改。' },
  ...
  precall: { title: '通话前设置', desc: 'Give the AI context before your call. The more specific you are, the sharper the coaching.', prospectName: '潜在客户姓名', prospectNamePlaceholder: '例如：张三', company: '公司', companyPlaceholder: '例如：某科技有限公司', callTypeQuestion: '这是什么类型的通话？', inCrmQuestion: '此潜在客户在您的CRM中吗？', callGoal: '通话目标', callGoalPlaceholder: '例如：预约演示、完成成交...', yourPitch: '您的方案/产品', yourPitchPlaceholder: '您在销售什么？', yourPerksLabel: '您的优势', yourPerksDesc: 'List everything great about your service — features, guarantees, pricing, differentiators. The AI will use this during the call.', crmRequired: 'Please select a lead from your CRM', crmSignInRequired: 'Sign in to load your CRM leads', language: '语言', startCall: '开始通话' },
  liveCall: { endCall: '结束通话', mute: '静音', unmute: '取消静音', aiSuggestions: 'AI建议', transcript: '实时转录', closeProbability: '成交概率', stage: '阶段', note: '备注', addNote: '添加备注...', listening: '监听中...', liveMode: '直播模式', noProspect: '无客户', active: '通话中', standby: '待机', objections: '异议', closeProb: '成交概率', aiFeed: 'AI智能推送', coaching: '辅导', readyToAssist: '准备就绪', readyDesc: '点击转录面板中的"监听"启动麦克风。', transcriptFeed: '实时转录', live: '直播', you: '您', prospect: '客户', system: '系统', listeningStatus: '监听中 — 说话人自动识别。', micStarting: '麦克风启动中...或在下方输入客户对话。', typeProspect: '输入客户说的话...', leadProfile: '客户资料', name: '姓名', company: '公司', goal: '目标', pitch: '产品介绍', callStats: '通话统计', quickActions: '快速操作', callNotes: '通话备注', noLeadData: '暂无客户数据。开始对话以建立资料。', summarizeCall: '总结通话', generateEmail: '生成跟进邮件', exportLead: '导出客户数据', scoreLead: '评分此客户', stageOpener: '开场', stageDiscovery: '挖掘需求', stagePitch: '产品介绍', stageClose: '促单', profile: '资料', listeningBubble: 'Listening to your call…', generatingReport: 'Generating your coaching report…', noTranscript: 'No transcript yet — start speaking before ending the call.', summaryFailed: 'Summary generation failed — call saved without AI coaching', micUnavailable: 'Microphone unavailable — transcription disabled', bodyUnavailable: error => `Body language coaching unavailable — ${error}`, draftFound: time => `Unsaved transcript found from ${time} — restore it?`, draftRestore: '恢复', draftDismiss: '忽略' },
  ...
  onboarding: { welcome: '欢迎使用Pitchr', yourName: '您的姓名', yourNamePlaceholder: '例如：张三', yourRole: '您的职位', yourRolePlaceholder: '例如：客户经理', whatYouSell: '您销售什么？', whatYouSellPlaceholder: '例如：SaaS、咨询、保险...', language: '偏好语言', letsGo: '开始 →' },
  upload: { title: '上传录音', subtitle: '上传通话录音，获取AI辅导和完整分析报告。', dropzone: '将音频文件拖放到此处', analyzing: '正在分析您的通话...', browseFiles: '浏览文件', analyzeTranscript: '分析记录' },
...
const ja: T = {
  ...
  common: { back: '戻る', cancel: 'キャンセル', save: '保存', send: '送信', start: '開始', done: '完了', close: '閉じる', loading: '読み込み中...', signOut: 'サインアウト', next: '次へ', skip: 'スキップ', edit: '編集', delete: '削除', confirm: '確認', tryAgain: '再試行', learnMore: '詳細を見る', or: 'または', yes: 'はい', no: 'いいえ', change: '変更' },
  profile: { activity: 'アクティビティ', calls: n => `${n} 件の通話`, trainingSessions: n => `${n} 件のトレーニング`, totalOnPlatform: 'プラットフォーム合計', maxRank: '✦ 最高ランク達成', appLanguage: 'アプリの言語', langNote: 'コーチングとトレーニングの言語に影響します。通話前設定で変更可能。' },
  ...
  precall: { title: '通話前設定', desc: 'Give the AI context before your call. The more specific you are, the sharper the coaching.', prospectName: '見込み客名', prospectNamePlaceholder: '例: 田中 太郎', company: '会社', companyPlaceholder: '例: 株式会社サンプル', callTypeQuestion: 'これはどのような種類の通話ですか？', inCrmQuestion: 'このリードはCRMにありますか？', callGoal: '通話目標', callGoalPlaceholder: '例: デモを予約、成約...', yourPitch: 'あなたの提案/製品', yourPitchPlaceholder: '何を販売していますか？', yourPerksLabel: 'あなたの強み', yourPerksDesc: 'List everything great about your service — features, guarantees, pricing, differentiators. The AI will use this during the call.', crmRequired: 'Please select a lead from your CRM', crmSignInRequired: 'Sign in to load your CRM leads', language: '言語', startCall: '通話開始' },
  liveCall: { endCall: '通話終了', mute: 'ミュート', unmute: 'ミュート解除', aiSuggestions: 'AI提案', transcript: 'トランスクリプト', closeProbability: '成約確率', stage: 'ステージ', note: 'メモ', addNote: 'メモを追加...', listening: '聴取中...', liveMode: 'ライブモード', noProspect: '見込み客なし', active: 'アクティブ', standby: 'スタンバイ', objections: '異議', closeProb: '成約率', aiFeed: 'AI インテリジェンスフィード', coaching: 'コーチング', readyToAssist: 'アシスト準備完了', readyDesc: 'トランスクリプトパネルの「聴取」をクリックしてマイクを開始。異議・購買シグナルをリアルタイムで検出します。', transcriptFeed: 'トランスクリプトフィード', live: 'ライブ', you: 'あなた', prospect: '見込み客', system: 'システム', listeningStatus: '聴取中 — スピーカーは自動検出されます。', micStarting: 'マイク起動中... または下に見込み客の発言を入力。', typeProspect: '見込み客の発言を入力...', leadProfile: 'リードプロフィール', name: '名前', company: '会社', goal: '目標', pitch: '提案', callStats: '通話統計', quickActions: 'クイックアクション', callNotes: '通話メモ', noLeadData: 'まだリードデータがありません。会話を開始してプロフィールを構築してください。', summarizeCall: '通話を要約', generateEmail: 'フォローアップメールを生成', exportLead: 'リードデータを書き出す', scoreLead: 'このリードをスコア', stageOpener: 'オープナー', stageDiscovery: 'ディスカバリー', stagePitch: 'ピッチ', stageClose: 'クロージング', profile: 'プロフィール', listeningBubble: 'Listening to your call…', generatingReport: 'Generating your coaching report…', noTranscript: 'No transcript yet — start speaking before ending the call.', summaryFailed: 'Summary generation failed — call saved without AI coaching', micUnavailable: 'Microphone unavailable — transcription disabled', bodyUnavailable: error => `Body language coaching unavailable — ${error}`, draftFound: time => `Unsaved transcript found from ${time} — restore it?`, draftRestore: '復元', draftDismiss: '無視' },
  ...
  onboarding: { welcome: 'Pitchrへようこそ', yourName: 'お名前', yourNamePlaceholder: '例: 田中 太郎', yourRole: '役職', yourRolePlaceholder: '例: アカウントエグゼクティブ', whatYouSell: '何を販売していますか？', whatYouSellPlaceholder: '例: SaaS、コンサルティング、保険...', language: '使用言語', letsGo: 'はじめる →' },
  upload: { title: '録音をアップロード', subtitle: '録音をアップロードしてAIコーチングと完全なレポートを取得してください。', dropzone: 'ここに音声ファイルをドロップ', analyzing: '通話を分析中...', browseFiles: 'ファイルを参照', analyzeTranscript: '文字起こしを分析' },
...
const ar: T = {
  ...
  common: { back: 'رجوع', cancel: 'إلغاء', save: 'حفظ', send: 'إرسال', start: 'بدء', done: 'تم', close: 'إغلاق', loading: 'جار التحميل...', signOut: 'تسجيل الخروج', next: 'التالي', skip: 'تخطي', edit: 'تعديل', delete: 'حذف', confirm: 'تأكيد', tryAgain: 'المحاولة مجددًا', learnMore: 'معرفة المزيد', or: 'أو', yes: 'نعم', no: 'لا', change: 'تغيير' },
  profile: { activity: 'النشاط', calls: n => `${n} مكالمة`, trainingSessions: n => `${n} جلسة تدريب`, totalOnPlatform: 'الإجمالي على المنصة', maxRank: '✦ تم الوصول للمرتبة القصوى', appLanguage: 'لغة التطبيق', langNote: 'يؤثر على لغة التدريب والإرشاد. يمكن تغييره لكل مكالمة في إعدادات ما قبل المكالمة.' },
  ...
  onboarding: { welcome: 'مرحبًا بك في Pitchr', yourName: 'اسمك', yourNamePlaceholder: 'مثال: محمد علي', yourRole: 'مسماك الوظيفي', yourRolePlaceholder: 'مثال: مدير حسابات', whatYouSell: 'ماذا تبيع؟', whatYouSellPlaceholder: 'مثال: برمجيات، استشارات، تأمين...', language: 'اللغة المفضلة', letsGo: 'لنبدأ →' },
  upload: { title: 'رفع تسجيل', subtitle: 'ارفع تسجيل مكالمة للحصول على تدريب ذكاء اصطناعي وتقرير كامل.', dropzone: 'اسحب ملف الصوت هنا', analyzing: 'جار تحليل مكالمتك...', browseFiles: 'استعراض الملفات', analyzeTranscript: 'تحليل النص' },
