    ...
    <div className="lp">
      ...
      <section id="features" className="lp__section lp__section--demo-scene">
        ...
        <div className={`lp__desktop-demo lp__desktop-demo--${demoPhase}`}>
          ...
          <div className={`lp__dd-expanded${demoPhase !== 'expanded' ? ' lp__dd-expanded--hiding' : ''}`}>
            ...
            <div className="lp__dd-statusbar">
              ...
              <div className="lp__dd-statusbar-right">
                ...
                <span className="lp__dd-stat">CLOSE PROB <span className={`lp__dd-stat-val lp__dd-stat-val--${desktopSceneIdx === 0 ? 'yellow' : 'green'}`}>{desktopSceneIdx === 0 ? 50 : desktopSceneIdx === 1 ? 68 : 81}%</span></span>
              </div>
            </div>
            <div className="lp__dd-panels">
              ...
              <div className={`lp__dd-panel lp__dd-panel--transcript${spotlight === 'transcript' ? ' lp__dd-panel--spotlight' : spotlight !== null ? ' lp__dd-panel--dimmed' : ''}`}>
                ...
                <div className="lp__dd-panel-hdr">
                  <div className="lp__dd-panel-hdr-left"><span className="lp__dd-panel-hdr-dot lp__dd-panel-hdr-dot--active" />TRANSCRIPT FEED</div>
                  {desktopShowSuggestion && <span className="lp__dd-panel-hdr-live">● LIVE</span>}
                </div>
                <div className="lp__dd-transcript">
                  {[
                    { who: 'rep', label: 'You', time: '00:48', text: 'Walk me through how your team currently handles pipeline reporting — who owns it and how often it changes.' },
                    { who: 'prospect', label: 'Prospect', time: '01:04', text: 'Right now it\'s mostly manual — our RevOps guy exports from Salesforce every Monday, cleans it up in Sheets, then shares it. By Wednesday it\'s already outdated.' },
                    { who: 'rep', label: 'You', time: '01:22', text: 'And when leadership asks for a pipeline update mid-week, what happens?' },
                    { who: 'prospect', label: 'Prospect', time: '01:35', text: 'Someone has to pull it again. It\'s maybe two hours of work each time just to get a number. It\'s frustrating.' },
                    { who: 'rep', label: 'You', time: '01:48', text: 'Two hours every time leadership asks — that adds up fast. Is there pressure to fix that before the end of Q2, or is it more of a Q3 conversation?' },
                  ].map((e, i) => (
                    <div key={i} className={`lp__dd-entry lp__dd-entry--${e.who}`}>
                      <div className="lp__dd-entry-meta">
                        <span className={`lp__dd-entry-who lp__dd-entry-who--${e.who}`}>{e.label}</span>
                        <span className="lp__dd-entry-time">{e.time}</span>
                      </div>
                      <div className="lp__dd-entry-text">{e.text}</div>
                    </div>
                  ))}
              ...
              <div className={`lp__dd-panel lp__dd-panel--ai${spotlight === 'ai' ? ' lp__dd-panel--spotlight' : spotlight !== null ? ' lp__dd-panel--dimmed' : ''}`}>
                ...
                <div className="lp__dd-panel-hdr lp__dd-panel-hdr--ai">
                  <div className="lp__dd-panel-hdr-left">AI INTELLIGENCE FEED<span className="lp__dd-ai-cursor">▋</span></div>
                  <span className={`lp__dd-stage-badge lp__dd-stage-badge--${DEMO_SCENES[desktopSceneIdx].stage.toLowerCase()}`}>{DEMO_SCENES[desktopSceneIdx].stage}</span>
                </div>
                  ...
                  {(desktopShowSuggestion || spotlight === 'ai') ? (
                    <div className={`lp__dd-suggestion lp__dd-suggestion--show${spotlight === 'ai' ? ' lp__dd-suggestion--spotlight-fade' : ''}`}>
                      <div className="lp__dd-suggestion-top">
                        <span className={`lp__dd-badge lp__dd-badge--${DEMO_SCENES[desktopSceneIdx].badgeType}`}>{DEMO_SCENES[desktopSceneIdx].cardBadge}</span>
                    ...
                    <div className="lp__dd-ai-empty">
                      ...
                      <div className="lp__dd-ai-empty-desc">Listening for objections, buying signals, and coaching moments.</div>
              ...
              <div className={`lp__dd-panel lp__dd-panel--lead${spotlight === 'notes' ? ' lp__dd-panel--spotlight' : spotlight !== null ? ' lp__dd-panel--dimmed' : ''}`}>
                ...
                <div className="lp__dd-lead-body">
                  ...
                  <div className="lp__dd-lead-section lp__dd-lead-section--notes">
                    ...
                    <div className="lp__dd-note-item"><span className="lp__dd-note-ts">0:48</span><span className="lp__dd-note-body">Uses Salesforce → manual Sheets export every Monday. Outdated by Wed.</span></div>
                    <div className="lp__dd-note-item"><span className="lp__dd-note-ts">1:35</span><span className="lp__dd-note-body">~2 hrs wasted per mid-week leadership update. RevOps owns it.</span></div>
                    <div className="lp__dd-note-item lp__dd-note-item--objection"><span className="lp__dd-note-ts">2:03</span><span className="lp__dd-note-body">Objection: Q3 priority freeze — product launch in the way.</span></div>
                    <div className="lp__dd-note-input-row"><span className="lp__dd-note-input-fake">Add note…</span><span className="lp__dd-note-btn">+</span></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* ── END-CLICKING ── */}
          {demoPhase === 'endclicking' && <div className="lp__dd-cursor lp__dd-cursor--endclick" />}
          ...
          <div className={`lp__dd-postcall${demoPhase === 'postcall' ? ' lp__dd-postcall--visible' : ''}`}>
            <div className="lp__dd-pc-wrap">
              <div className="lp__dd-pc-hdr">
                ...
                <div className="lp__dd-pc-title-block">
                  ...
                  <div className="lp__dd-pc-meta">
                    <span>Amara Osei</span><span className="lp__dd-pc-meta-sep">@</span><span>Meridian Growth</span>
                    <span className="lp__dd-pc-meta-sep">·</span><span>Tue, Apr 28, 2026, 09:38 PM</span>
                  </div>
                </div>
              ...
              <div className="lp__dd-pc-content">
                {demoPhase === 'postcall' && postcallTab === 'summary' && <div key="ann-summary" className="lp__dd-pc-ann"><div className="lp__dd-pc-ann-stamp">AI SUMMARY</div><div className="lp__dd-pc-ann-text">What went well, gaps, and next steps</div></div>}
                {demoPhase === 'postcall' && postcallTab === 'transcript' && <div key="ann-transcript" className="lp__dd-pc-ann"><div className="lp__dd-pc-ann-stamp">FULL TRANSCRIPT</div><div className="lp__dd-pc-ann-text">Every word timestamped — search, review, share</div></div>}
                {demoPhase === 'postcall' && postcallTab === 'email' && <div key="ann-email" className="lp__dd-pc-ann"><div className="lp__dd-pc-ann-stamp">READY TO SEND</div><div className="lp__dd-pc-ann-text">Personalised follow-up drafted instantly — just hit send</div></div>}
                {demoPhase === 'postcall' && postcallTab === 'scorecard' && <div key="ann-scorecard" className="lp__dd-pc-ann"><div className="lp__dd-pc-ann-stamp">REP SCORECARD</div><div className="lp__dd-pc-ann-text">Talk ratio, objections handled, close probability</div></div>}
                {demoPhase === 'postcall' && postcallTab === 'share' && <div key="ann-share" className="lp__dd-pc-ann"><div className="lp__dd-pc-ann-stamp">SHARE INSTANTLY</div><div className="lp__dd-pc-ann-text">Send the call summary to your team in one click</div></div>}
                ...
                {postcallTab === 'email' && (
                  <div className="lp__dd-pc-email">
                    ...
                    <div className="lp__dd-pc-email-integrations"><span>▶</span> Integrations (Zapier / Webhook)</div>
                  </div>
                )}
                ...
                {postcallTab === 'scorecard' && (
                  <div className="lp__dd-pc-scorecard">
                    <div className="lp__dd-pc-sc-ring-wrap">
                      <div className="lp__dd-pc-sc-ring" style={{background:'conic-gradient(var(--color-text-primary) calc(59% * 1), rgba(128,128,128,0.15) 0)'}}>
                    ...
                    <div className="lp__dd-pc-sc-metric">
                      ...
                      <div className="lp__dd-pc-sc-gauge">
                        <div className="lp__dd-pc-sc-gauge-fill" style={{width:'61%'}} />
                      </div>
                    </div>
                  </div>
                )}
        ...
        <div className="lp__demo-nav">
          <button className="lp__demo-nav-btn" onClick={() => handleDemoNav(-1)} aria-label="Previous step">← PREV</button>
          ...
          <button className="lp__demo-nav-btn" onClick={() => handleDemoNav(1)} aria-label="Next step">NEXT →</button>
        </div>
